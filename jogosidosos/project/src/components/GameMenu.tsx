...
interface GameMenuProps {
  onGameSelect: (game: 'solitaire' | 'sudoku' | 'memory' | 'coloring' | 'music' | 'jigsaw') => void;
}
...
const GameMenu: React.FC<GameMenuProps> = ({ onGameSelect }) => {
  ...
  return (
    <div 
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(239, 246, 255, 0.9), rgba(219, 234, 254, 0.9)), url('https://images.pexels.com/photos/7551667/pexels-photo-7551667.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')`,

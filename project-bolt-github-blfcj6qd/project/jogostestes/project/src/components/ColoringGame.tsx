...
import { ArrowLeft, RotateCcw, Palette, Download, Image } from 'lucide-react';
...
export default function ColoringGame({ onBack }: ColoringGameProps) {
  ...
  const drawings = [
    {
      name: 'Flores Bonitas',
      url: 'https://images.pexels.com/photos/1407322/pexels-photo-1407322.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&dpr=1'
    },
    {
      name: 'Gatinho Fofo',
      url: 'https://images.pexels.com/photos/45201/kitty-cat-kitten-pet-45201.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&dpr=1'
    },
    {
      name: 'Cachorro Amigável',
      url: 'https://images.pexels.com/photos/1108099/pexels-photo-1108099.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&dpr=1'
    },
    {
      name: 'Borboleta Colorida',
      url: 'https://images.pexels.com/photos/326055/pexels-photo-326055.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&dpr=1'
    },
    {
      name: 'Paisagem Natural',
      url: 'https://images.pexels.com/photos/417074/pexels-photo-417074.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&dpr=1'
    }
  ];
